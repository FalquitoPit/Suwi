...
public class Gestion_Libros {
	...
	public void menu() {
		...
		do {
			...
			opcion=Pedir_Datos.leerEntero("¿Qué desea hacer?");
			switch (opcion) {
			case 1:
				addLibro();
				break;
	...
	private void addLibro() {
		...
		long isbn=Pedir_Datos.leerLong("Introduzca el ISBN del libro que desea añadir.");
		...
		String signatura=Pedir_Datos.leerCadena("Introduzca la signatura.");
		String titulo=Pedir_Datos.leerCadena("Introduzca el título.");
		String autor=Pedir_Datos.leerCadena("Introduzca el autor.");
		String materia=Pedir_Datos.leerCadena("Introduzca la materia.");
		String editorial=Pedir_Datos.leerCadena("Introduzca la editorial.");
	...
	private void delLibro() {
		...
		long isbn=Pedir_Datos.leerLong("Introduzca el ISBN del libro que desea eliminar.");
